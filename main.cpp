...
/// <summary>
/// Programos vykdymo laiko matavimo funkciju klase
/// </summary>
class Timer {
private:
	std::chrono::time_point<std::chrono::high_resolution_clock> start; ///< Matavimo pradzios laiko momentas.
public:
	/// Numatytasis konstruktorius.
	Timer() : start{ std::chrono::high_resolution_clock::now() } {}
	/// Matavimo pradzios laiko momento fiksavimas
	void reset() {
		start = std::chrono::high_resolution_clock::now();
	}
	/// Programos vykdymo laiko paskaiciavimas
